...
namespace Jinaidah.Migrations
{
    ...
    [Migration("20200223111642_testfy")]
    partial class testfy
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Jinaidah.Models.HoldingInfo", b =>
                {
                    ...
                    b.Property<string>("HoldingCategoryId")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<int?>("HoldingCategoryId1")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("HoldingTypeId")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<int?>("HoldingTypeId1")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("HoldingCategoryId1");

                    b.HasIndex("HoldingTypeId1");
            ...
            modelBuilder.Entity("Jinaidah.Models.HoldingInfo", b =>
                {
                    ...
                    b.HasOne("Jinaidah.Models.HoldingCategory", "HoldingCategory")
                        .WithMany()
                        .HasForeignKey("HoldingCategoryId1");

                    b.HasOne("Jinaidah.Models.HoldingType", "HoldingType")
                        .WithMany()
                        .HasForeignKey("HoldingTypeId1");
            ...
            modelBuilder.Entity("Jinaidah.Models.HoldingType", b =>
                {
                    b.HasOne("Jinaidah.Models.WaterRate", "WaterRate")
                        .WithMany("HoldingTypes")
